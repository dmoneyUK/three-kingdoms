...
- Rock Cleaving Axe decisions now also show an unmistakable centre-table prompt when an Attack is Dodged, explaining the two-card cost and offering **Use Rock Cleaving Axe** or **Skip Axe** throughout the fresh response window.
