...
- Bumper Harvest keeps every revealed card on one shared choice panel, requires confirmation, names the current chooser, and clearly raises and shades cards as humans or bots take them in order.
