...
Hero-selection cards now include an accessible info icon. Opening it shows the
selected general's faction, HP, and authoritative ability text without changing
the current hero selection.
