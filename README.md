...
- Frost Sword is playable with Attack Range 2. When its Attack would deal damage — including against an undefended bot — its owner gets the same centred, fresh 10-second choice pattern as Rock Cleaving Axe: prevent the damage and discard up to two of the target's current cards, or deal the damage normally.
