      ...
      <div className="turn-controls">
        ...
        <div>
          <section className="hero-skills" aria-label="Hero Skills">
            ...
            {me?.hero === "guan-yu" && <button type="button" className={`hero-skill-button ${wushengMode ? "active" : ""}`} disabled={busy || wushengMode === null && !canUseWushengInPlay && !canUseWushengInResponse} onClick={() => {
