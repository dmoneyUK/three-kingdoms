...
test("client keeps the turn, response, presentation, and selection controls", async () => {
  ...
  assert.doesNotMatch(page, /rescue-peach-choice/);
  assert.doesNotMatch(styles, /rescue-decision-stage/);
  assert.match(page, /cardId: card\.id/);
  assert.match(page, /rescueDecisionReady && item\.kind !== "Peach"/);
  assert.doesNotMatch(page, /PRIVATE RESCUE DECISION/);
  ...
  assert.doesNotMatch(page, /role="alertdialog"/);
  ...
  assert.match(page, /const submitResponseProvider = async/);
  assert.match(page, /selectedIds\.length < selection\.min \|\| selectedIds\.length > selection\.max/);
  assert.match(page, /providerId: provider\.providerId/);
  assert.match(page, /cardIds: selectedIds/);
  ...
  assert.match(page, /pendingTargetCard/);
  assert.match(page, /choose_target_card/);
  assert.match(page, /targetCardZone/);
  assert.match(page, /Obtain selected/);
  assert.match(page, /Discard selected/);
  assert.match(page, /Rejoin game/);
