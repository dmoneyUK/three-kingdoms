...
try {
  await waitForServer();
  const tests = spawn(process.execPath, ["--import", "tsx", "--test", "--test-concurrency=1", "tests/dying.test.mjs", "tests/standard-deck.test.mjs", "tests/private-hand.test.mjs", "tests/response-capabilities.test.mjs", "tests/room-safety.test.mjs", "tests/room-safety-render.test.mjs", "tests/rendered-html.test.mjs", "tests/game-api.test.mjs"], { cwd: new URL("../", import.meta.url), env: { ...process.env, GAME_TEST_URL: url }, stdio: "inherit" });
