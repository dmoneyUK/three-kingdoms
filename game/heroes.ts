...
export const STANDARD_HEROES: readonly HeroDefinition[] = [
  ...
  standard("zhou-yu","Zhou Yu","Wu",3,"Draw an extra card; challenge a player to guess a card's suit.","male", [{ name: "Yingzi", description: "Draw one additional card during your Draw Phase." }, { name: "Fanjian", description: "Once during your Play Phase, give a hand card to another character and have them guess its suit; a wrong guess causes 1 damage." }]),
