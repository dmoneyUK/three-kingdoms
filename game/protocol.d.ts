...
export type ResponseOptionView = { providerId: string; satisfies: ResponseRequirement; label: string; selection: ResponseSelection };
export type CurrentAction = { version: 1; kind: PendingKind | "turn" | "none"; actorId: string | null; deadline: number; reason: string; legalActions: GameplayAction[]; requirement?: ResponseRequirement; options?: ResponseOptionView[]; declineAction?: GameplayAction };
