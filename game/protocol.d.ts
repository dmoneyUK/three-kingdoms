...
export type CurrentAction = { version: 3; kind: PendingKind | "response" | "turn" | "none"; actorId: string | null; deadline: number; reason: string; legalActions: GameplayAction[]; canDeclareAttack?: boolean; playPhaseActions?: PlayPhaseActionView[]; requirement?: ResponseRequirement; options?: ResponseOptionView[]; triggerEvent?: "turn_start" | "judgement_revealed" | "attack_targeted" | "attack_dodged" | "damage_about_to_apply" | "damage_suffered"; triggerOptions?: TriggerOptionView[]; declineAction?: GameplayAction; presentation?: { resolutionId: string | null; readyAfterEventId: string | null } };
