...
/** Jianxiong obtains the card(s) that caused Cao Cao's damage when available. */
export const caoCaoJianxiongTrigger: TriggeredEffect = {
  ...
  getOption(context) {
    ...
    return { effectId: "cao_cao_jianxiong", label: "Jianxiong", description: "Obtain the card that caused the damage, if it is still available.", selection: null };
  },
  resolve(context) {
