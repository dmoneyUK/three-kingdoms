...
/** Heroic is an optional modifier for Zhou Yu's normal Draw Phase only. */
export const zhouYuYingziTrigger: TriggeredEffect = {
  id: "zhou_yu_yingzi",
  event: "draw_phase",
  getOption: (context) => context.hero === "zhou-yu"
    ? { effectId: "zhou_yu_yingzi", label: "Heroic", description: "Draw one additional card this Draw Phase.", selection: null, allowDecline: true }
    : null,
