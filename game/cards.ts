...
export const CARD_DEFINITIONS: Record<CardKind, CardDefinition> = {
  ...
  BorrowedSword: { kind: "BorrowedSword", name: "Borrowed Sword", product: "standard", category: "stratagem", target: "opponent", description: "Force a Weapon holder to Attack", rules: "Target another character who has a Weapon. That character must play Attack against a legal second target chosen by you; otherwise you obtain that character's Weapon." },
  ...
  BlueSteelSword: { kind: "BlueSteelSword", name: "Blue Steel Sword", product: "standard", category: "equipment", target: "self", equipmentSlot: "weapon", attackRange: 2, description: "Weapon · range 2", rules: "Equip this weapon during your Play Phase. Your Attack ignores the target's Armor effects without removing that Armor." },
  YinYangSwords: { kind: "YinYangSwords", name: "Yin-Yang Swords", product: "standard", category: "equipment", target: "self", equipmentSlot: "weapon", attackRange: 2, description: "Weapon · range 2", rules: "Equip this weapon during your Play Phase. When your Attack targets a character of the opposite gender, they choose to discard a hand card or let you draw a card." },
  ...
  KirinBow: { kind: "KirinBow", name: "Kirin Bow", product: "standard", category: "equipment", target: "self", equipmentSlot: "weapon", attackRange: 5, description: "Weapon · range 5", rules: "Equip this weapon during your Play Phase. When your Attack inflicts damage, you may discard one Mount from the damaged character's Equipment Zone." },
  ...
  EightTrigrams: { kind: "EightTrigrams", name: "Eight Trigrams Formation", product: "standard", category: "equipment", target: "self", equipmentSlot: "armor", description: "Armor · judgement may provide Dodge", rules: "When you need to play Dodge, you may perform Judgement. If the result is red, treat it as Dodge; if black, the Attack takes effect normally.", officialCardId: 176 },
  Shadowrunner: { kind: "Shadowrunner", name: "Shadowrunner", product: "standard", category: "equipment", target: "self", equipmentSlot: "defensiveHorse", description: "Incoming distance +1", rules: "Equip this horse during your Play Phase. Other characters treat their distance to you as 1 greater.", officialCardId: 190 },
  HexMark: { kind: "HexMark", name: "Hex Mark", product: "standard", category: "equipment", target: "self", equipmentSlot: "defensiveHorse", description: "Incoming distance +1", rules: "Equip this horse during your Play Phase. Other characters treat their distance to you as 1 greater." },
  YellowHoofedFlyingLightning: { kind: "YellowHoofedFlyingLightning", name: "Yellow-Hoofed Flying-Lightning", product: "standard", category: "equipment", target: "self", equipmentSlot: "defensiveHorse", description: "Incoming distance +1", rules: "Equip this horse during your Play Phase. Other characters treat their distance to you as 1 greater." },
  RedHare: { kind: "RedHare", name: "Red Hare", product: "standard", category: "equipment", target: "self", equipmentSlot: "offensiveHorse", description: "Outgoing distance -1", rules: "Equip this horse during your Play Phase. Your distance to other characters is treated as 1 less, to a minimum of 1." },
  PurpleBay: { kind: "PurpleBay", name: "Purple Bay", product: "standard", category: "equipment", target: "self", equipmentSlot: "offensiveHorse", description: "Outgoing distance -1", rules: "Equip this horse during your Play Phase. Your distance to other characters is treated as 1 less, to a minimum of 1." },
  FerganaSteed: { kind: "FerganaSteed", name: "Fergana Steed", product: "standard", category: "equipment", target: "self", equipmentSlot: "offensiveHorse", description: "Outgoing distance -1", rules: "Equip this horse during your Play Phase. Your distance to other characters is treated as 1 less, to a minimum of 1.", officialCardId: 182 },
  // Compatibility for games created before mounts were represented as distinct physical cards.
  OffensiveHorse: { kind: "OffensiveHorse", name: "Fergana Steed", product: "standard", category: "equipment", target: "self", equipmentSlot: "offensiveHorse", description: "Outgoing distance -1", rules: "Equip this horse during your Play Phase. Your distance to other characters is treated as 1 less, to a minimum of 1.", officialCardId: 182 },
